...
LNG.menu_choose_ai = [[Valitse tekoälyt otteluun:]]
LNG.menu_choose_ai_tooltip = [[Valitse tämä tekoäly otteluun]]

LNG.menu_choose_dimensions = [[Kartan leveys ja korkeus:]]
...
LNG.menu_time_tooltip[1] = [[Perusasetus, keskiverrosti matkustajia]]
