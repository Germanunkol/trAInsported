...
function statusMsg.init()
	if not statusMsgBoxThread and not statusMsgBox then		-- only start thread once!
		...
		if not ok then
			...
			statusMsgBoxThread:set("shadowOffsetX", 10 )
			statusMsgBoxThread:set("shadowOffsetY", 0 )
	...
	if not statusErrBoxThread and not statusErrBox then		-- only start thread once!
		...
		if not ok then
			...
			statusErrBoxThread:set("shadowOffsetX", 10 )
			statusErrBoxThread:set("shadowOffsetY", 0 )
